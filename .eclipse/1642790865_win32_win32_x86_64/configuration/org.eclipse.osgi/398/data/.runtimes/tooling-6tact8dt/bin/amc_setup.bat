...
IF EXIST "%BASE_DIR%\bin\agent-setup-2.4.27-amc-final.jar" move "%BASE_DIR%\bin\agent-setup-2.4.27-amc-final.jar" "%BASE_DIR%\tools"
java -jar "%BASE_DIR%\tools\agent-setup-2.4.27-amc-final.jar" %*
